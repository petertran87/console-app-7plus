...
namespace ConsoleApp7Plus.Abstraction
{
	...
	public abstract class ApiInteraction<T>
	{
		...
		public abstract Task<T> GetRecordById(int id);
		...
		public abstract Task<Dictionary<int, TDerived>> GetRecords<TDerived>() where TDerived : T;
		...
		public abstract Task UpdateRecord<TDerived>(TDerived data) where TDerived : T;
	}
}
